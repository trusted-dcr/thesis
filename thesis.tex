...
\begin{titlepage}
	...
	\begin{abstract}
		...
		We also explore the security and optimization options provided by recent advances in trusted execution environments (TEE), specifically Intel Secure Guard Extensions (SGX), to achieve byzantine fault tolerance in the context of this problem.
