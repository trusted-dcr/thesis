...
% Description of components covered in this section and why they are needed.
	...
	We denote this execution $E(G,e)=G'$.
			...
			More formally, given a graph, $G$, and two events $e_1, e_2$ in $G$, such that $E(G,e_1) = G'$, and $E(G,e_2) = G''$, we say that $e_1$ and $e_2$ are concurrent if $E(E(G, e_1),e_2)=E(E(G, e_2),e_1)$.
