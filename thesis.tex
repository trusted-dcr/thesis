...
\end{snippet}
	...
	Methods such as the secret sharing scheme of FastBFT, as described in~\cite{liu_scalable_2016}, could possible be utilised to great effect in our solution.
	...
	A main concern with the SGX project 
	% Scalability
