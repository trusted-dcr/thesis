...
\end{description}
	...
	Additionally, the snapshot algorithm requires flooding of the entire network, which results in $O(v)$  messages, where $v$ is the number of event pairs with at least one relation between them in the DCR graph.
