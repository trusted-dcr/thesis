...
s
	...
	\makebox[\textwidth][c]{\begin{tabular}{|p{1.5cm}|p{1.5cm}|p{1.5cm}|p{1.7cm}|p{2cm}|p{2cm}|p{1.5cm}|}
	\hline
	Solution   & Fault tolerance (Availability) & Fault tolerance (Safety) & Fault tolerance (Data loss) & Nb. of messages for state change (Best case)       & Concurrency           & Request Bottleneck    \\ \hline
