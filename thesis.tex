...
A DCR graph is a representation of a workflow, made up of one or more events with a number of relations between them. 
		...
		\begin{description}
			\item[Effects] which are relations that propagate an execution to other events, in the sense that they change the state of the targeted event. These are the \emph{response}, \emph{include} and \emph{exclude} relations.
