...
\section{Intel SGX}
	...
	On collecting the global state of this graph, \texttt{A} might return a number of executions of itself, while \texttt{C} will return a sequence of a single \texttt{A} execution followed by a number of \texttt{C} executions
