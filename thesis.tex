...
\end{snippet}
	...
	% will show that the system can be used generically
	% only view as effects and constraints
	%
    Vi vil nu gerne vise at systemet kan udbygges til at være mere generisk.
    Vi forestiller os et generisk system, bestående af 
