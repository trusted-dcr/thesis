...
% Description of components covered in this section and why they are needed.
	...
	\textit{4} & $\lfloor \frac{(m-1)}{2} \rfloor$ (partly) & $n$                      & $m-1$                       & $O(m)$                    & $2\cdot\lfloor\frac{(m-1)}{2}\rfloor$     		& Dynamic independence        & $L\cdot \frac{n}{m}$ \\ 
	\textit{5} & $0$ (partly)                               & $n$                      & $0$                         & n/a                       & $2\cdot D_{dyn}(G,e)$           					& Dynamic independence        & $L\cdot n$ \\ 
	\bottomrule
	\end{tabular}}
