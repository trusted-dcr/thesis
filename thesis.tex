...
\section{Introduction}
	...
	\begin{itemize}
		...
		\item A transformation of any crash-stop tolerant consensus algorithm to a byzantine fault tolerant one, using Intel SGX.
		\item An algorithm for achieving consensus in a decentralized and distributed state replication system, part of which is an SGX version of Raft~\cite{ongaro_search_2014}.
	...
	\begin{description}
		\item[Distributed state] Supporting the distribution of the state of the DCR graph among the participants.
		\item[Concurrent] Allowing for a high degree of concurrency as permitted by the specific DCR graph, as shown in~\cite{debois_concurrency_2015}, while achieving consensus in a number of messages less than the number of nodes in the graph.
