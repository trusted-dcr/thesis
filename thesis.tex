...
\end{lstlisting}
	...
	\begin{itemize}
		\item If an event, \textit{a}, happened before another event, \textit{b}, and \textit{b} is included in the cut, then so it \textit{a}.
	...
	Each event will always be able to present an empty sequence, as an example of a consistent cut, trivially an empty sequence.
