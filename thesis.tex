...
The graph is made up of one or more activities with a number of relations between them. 
		...
		This is an activity: $\ev{A}{0}{0}{1}$
			...
			The executed attribute is shown as a tick mark: $\ev{A}{1}{0}{1}$
			...
			The pending attribute is shown as an exclamation point: $\ev{A}{0}{1}{1}$
			...
			The included attribute is denoted by the outline of the activity: $\ev{A}{0}{0}{1}$ when included and $\ev{A}{0}{0}{0}$ when excluded.
		...
		% TODO: Effects and constraints
			...
			This described situation can be shown as: $\ev{A}{0}{0}{1} \crel \ev{B}{0}{0}{1}$
			...
			This described situation can be shown as: $\ev{A}{0}{0}{1} \rrel \ev{B}{0}{0}{1}$
			...
			This described situation can be shown as: $\ev{A}{0}{0}{1} \irel \ev{B}{0}{0}{1}$
			...
			This described situation can be shown as: $\ev{A}{0}{0}{1} \erel \ev{B}{0}{0}{1}$
			...
			This described situation can be shown as: $\ev{A}{0}{0}{1} \mrel \ev{B}{0}{0}{1}$
...
\section{Problem}
	...
	As shown in section \ref{sec:algorithm}, execution of an event must be pushed to effected neighbours (1), and executions of non-independent events must be synchronised. 
	...
	\begin{description}
		\item[1: Exclude-include] $\ev{A}{0}{0}{1} \erel \ev{D}{0}{0}{1}, \ev{A}{0}{0}{1} \irel \ev{C}{0}{0}{1}, \ev{B}{0}{0}{1} \erel \ev{C}{0}{0}{1}, \ev{B}{0}{0}{1} \irel \ev{D}{0}{0}{1}$
		\item[2: Include condition] $\ev{A}{0}{0}{1} \irel \ev{C}{0}{0}{0}, \ev{C}{0}{0}{0} \crel \ev{B}{0}{0}{1}, \ev{B}{0}{0}{1} \irel \ev{D}{0}{0}{0}, \ev{D}{0}{0}{0} \crel \ev{A}{0}{0}{1}$
		\item[3: Non-modifying to condition] $\ev{A}{0}{0}{1} \irel \ev{C}{0}{0}{1}, \ev{C}{0}{0}{1} \crel \ev{B}{0}{0}{1}, \ev{B}{0}{0}{1} \irel \ev{D}{0}{0}{0}, \ev{D}{0}{0}{0} \crel \ev{A}{0}{0}{1}, \ev{E}{0}{0}{1} \erel \ev{C}{0}{0}{1}$
	\end{description}
