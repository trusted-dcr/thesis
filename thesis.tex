...
% Description of components covered in this section and why they are needed.
	...
	\begin{description}
		\item[Consensus] In extension to preventing simultaneous incompatible executions, locking has pushed the issue of concurrency into the locking portion, which now needs to be handled in the sense that peers must agree who holds the locks.
