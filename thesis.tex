...
\section{Introduction}
	...
	As DCR graphs provide rights on actor by actor basis, it is unintuitive for the distribution of DCR graphs to support dynamic joining of the network.
...
% Description of components covered in this section and why they are needed.
	...
	This concludes the argument that Intel SGX and cryptography can change byzantine faults to crash faults, and thereby, using the above transformation, make a crash-resistant protocol into a byzantine-fault-tolerant protocol.
		...
		We will now show a practical example of how the transformation in section \ref{subsubsec:transforming-byzantine-faults} can be utilised.
	...
	% Reiterate problem as in-depth as possible. Termination, Liveness etc requirements?
	...
	% Define terms used in the section: neighbourhoods(in/out)(open/closed)
	% List challenges/subsections: consensus, locking, network, global state, etc.
