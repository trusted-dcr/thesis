...
\end{description}
	...
	This is denoted with a $C$ prefix: $CN_{in}$ or $CN_{out}$.
	...
	Recall the definitions from Section~\ref{subsubsec:concurrency}, where the dependencies in DCR graphs are explained, and realize that dynamic independence goes a long way towards describing the cases where ordering is not needed.
